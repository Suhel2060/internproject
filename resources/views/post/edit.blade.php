                  ...
                  <form method="post" action="{{route('post.update',$post)}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            <div class="custom-file">
                              ...
                              <label class="custom-file-label" for="inputGroupFile02" aria-describedby="inputGroupFileAddon02" multiple>Choose file</label>
                       
                            </div>
                            @if ($post->postimage)
                            @foreach ( $post->postimage as $images)
                            <img src="{{ asset('images/'.$images->images) }}" alt="{{ $post->title }}" width="100" height="100">
                            @endforeach
                      ...
                      <select class="form-control" name="catagory" id="catagory">
                        ...
                        <option value="{{$item->id}}" {{ $item->id==$post->catagory_id?'selected':'' }}>{{ $item->catagory }}</option>
                        @endforeach
